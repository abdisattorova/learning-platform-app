...
<div style="padding: 20px">
    <form id="course-form" method="post" action="/courses">
        ...
        <%--                </c:when>--%>
        <%--                <c:otherwise>--%>
        <%--                    <input hidden name="id" type="number" class="form-control" value="${-1}">--%>
        <%--                </c:otherwise>--%>
        <%--            </c:choose>--%>
        <%--        </div>--%>
        <div class="form-group">
        ...
        <%--            <select required data-placeholder="Select author..." multiple class="chosen-select" name="authorsId"--%>
        <%--                    id="authors">--%>
        <%--                <c:choose>--%>
        <%--                    <c:when test="${selectedCourse!=null}">--%>
        <%--                        <c:forEach var="author" items="${selectedCourse.authors}">--%>
